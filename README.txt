# Barachel’s Portfolio

This repository contains the source code for my personal Business Analyst portfolio.
...
- A Work section with individual project pages  
- Project artefacts such as:
